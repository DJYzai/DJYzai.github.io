...
function  create() {
    ...
    kd.href = 'https://www.iculture.cc/demo/camera/?id='+myid.value+'&url='+url.value; 
    kd.style = ''; 
    kd.innerText = 'https://www.iculture.cc/demo/camera/?id='+myid.value+'&url='+url.value; 
}
   </script>
   ...
   <p>拍摄后跳转到：<input type= "text" id="url"  value= 'https://www.baidu.com'/></p>
   <p><input type= "button"  value= '生成链接'  onclick= 'create();'  />   
   <input type="button" value='查看照片' onclick=window.location.href='ck.php?id='+document.getElementById('myid').value> </p>
